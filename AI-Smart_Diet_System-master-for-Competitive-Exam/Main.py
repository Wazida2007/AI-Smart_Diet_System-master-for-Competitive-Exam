...
def main():
	...
	print("\n"
		"#################################\n"
		"#                               #\n"
		"#   Welcome to AI Diet System   #\n"
		"#     For Competative Exams     #\n"
                "#                               #\n"
		"#################################\n"
	...
	if response.lower() == 'y':
		...
		while(incorrect_input):
			Examination = int(input("\nYour Examination:\n" +
				...
				"4 - UPSC\n"
				"5 - JEE Advance\n"));
			if Examination >= 1 and Examination <= 5:
				break;
			else:
				print("\n>> Invalid input. Please re-enter.");
		...
		users.append(User(user_name, age, gender.lower(), height, weight, weight_goal, Examination));
